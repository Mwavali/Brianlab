                  ...
                  <div class="row">
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      ...
                      <div class="row">
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn  light-blue waves-effect waves-light right" type="submit" name="action">Submit
...
?>
 ...
 <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
      <span>Copyright JoyMariam © <?php echo date("Y"); ?><span class="right"><a class="grey-text text-lighten-4" href="https://sourcecodester.com">Joy 22/04010</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
