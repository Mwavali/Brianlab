    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-light-blue"><i class="mdi-maps-local-restaurant"></i> Meal Card Menu</a>
            </li>
                <li class="no-padding">
...
<table>
			  ...
			  <div class="input-field col s12">
                              <button class="btn  light-blue waves-effect waves-light right" type="submit" name="action">Modify
