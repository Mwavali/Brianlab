        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">Meal Card Management System</a></h1></li>
                    </ul>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-light-blue"><i class="mdi-maps-local-restaurant"></i> Order Mealcard Food</a>
            </li>
                <li class="no-padding">
...
<?php
    echo '<li class="collection-item avatar">
        <i class="mdi-content-content-paste light-blue circle"></i>
...
<button class="btn  light-blue waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>Confirm Order
  ...
  <!-- //////////////////////////////////////////////////////////////////////////// -->
   ...
   <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
      <span>Copyright Joy Mariam © <?php echo date("Y"); ?><span class="right"><a class="grey-text text-lighten-4" href="https://sourcecodester.com">Joy 22/04010</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
